package com.sfl.coolmonkey.translations.api.rest.resources.aspect;
...
public class ResourceMethodLoggingAspect {
    ...
    @Around("execution(public * com.sfl.coolmonkey.translations.api.rest.resources..* (..))")
    ...
    @AfterThrowing(value = "execution(public * com.sfl.coolmonkey.translations.api.rest.resources..* (..))",
            throwing = "e")
